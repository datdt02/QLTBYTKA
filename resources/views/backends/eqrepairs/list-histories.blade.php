                    ...
                    <div class="col-md-2 filter">
                        <ul class="nav-filter">
                            <li class=""><a class="btn btn-success" style="color: #fff;"
                                    href="{{ route('eqrepair.historyExport', ['equip_id' => $equipment->id ]) }}"><i class="far fa-file-excel"></i>
                                    {{ __('Xuất Excel') }}</a></li>
                        </ul>
                    </div>
                    <div class="col-md-9">
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-info btn-sm"
                                                            href="{{ route('eqrepair.edit', ['equip_id' => $equipment->id, 'repair_id' => $repair->id]) }}"><i
                                                                class="fas fa-edit"></i></a>
                                                        <a class="btn btn-danger btn-sm"
                                                            href="{{ route('eqrepair.delete', ['equip_id' => $equipment->id, 'repair_id' => $repair->id]) }}"
