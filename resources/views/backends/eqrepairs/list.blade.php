...
@section('title', __('Danh sách thiết bị đang báo hỏng và sửa chữa'))
@section('content')
    @php
    ...
    <div id="list-events" class="content-wrapper events">
        <section class="content">
            <div class="head container">
                <h1 class="title">{{ __('Danh sách thiết bị đang báo hỏng và sửa chữa') }}</h1>
            </div>
            <div class="main">
                <div class="row search-filter">
                    <div class="col-md-3 filter">
                        <ul class="nav-filter">
                            <li class="active"><a href="{{ route('eqrepair.index') }}">{{ __('Tất cả') }}</a>
                            </li>
                        </ul>
                    </div>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td class="group-action action text-nowrap">
                                                        ...
                                                        <a class="btn btn-primary btn-xs"
                                                            href="{{ route('eqrepair.history', ['equip_id' => $equipment->id]) }}"
                                                        ...
                                                        @if (($equipment->status != 'corrected' && $check) || ($count == 0))
                                                            <a class="btn btn-danger btn-xs"
                                                                href="{{ route('eqrepair.create', ['equip_id' => $equipment->id]) }}"
                                                        ...
                                                        @else
                                                            ...
                                                            <a class="btn btn-primary btn-xs"
                                                                href="{{ route('eqrepair.exportWord', $equipment->id) }}"
                                                        ...
                                                        @if (isset($item) && $check && $equipment->status == 'corrected')
                                                            <a class="btn btn-success btn-xs btn-repair"
                                                                href="{{ route('eqrepair.stateTransition', ['equip_id' => $equipment->id]) }}"
