        ...
        <section class="content">
            <div class="container">
                ...
                <div class="main">
                    ...
                    <form action="{{ route('equipment.post') }}" class="dev-form"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="risk">
                                                ...
                                                @foreach ($get_statusRisk as $key => $items)
                                                    <option value="{{ $key }}"
                                                        {{ ($items)  == (Request::old('risk')) ? "selected" : ""}}
                                                    >
                                                        {{ $items }}
                                                    </option>
                                                @endforeach
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="last_maintenance" type="date" class="form-control"
                                                   value="{{ Request::old('last_maintenance') }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control select2" name="regular_inspection">
                                            ...
                                            @foreach ($get_RegularInspection as $key => $value)
                                                <option
                                                    value="{{ $key }}" {{ ($key)  == (Request::old('regular_inspection')) ? "selected" : ""}}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="last_inspection" type="date" class="form-control"
                                                   value="{{ Request::old('last_inspection') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control select2" name="periodic_radiation_inspection">
                                            <option value="">Chọn tháng</option>
                                            <option
                                                value="0" {{ 0 == old("periodic_radiation_inspection") ? 'selected':'' }}>
                                                {{__("Không bắt buộc")}}</option>
                                            <option
                                                value="12" {{ 12 == old("periodic_radiation_inspection") ? 'selected':'' }}>{{__("12 tháng")}}</option>
                                            <option
                                                value="24" {{ 24 == old("periodic_radiation_inspection") ? 'selected':'' }}>{{__("24 tháng")}}</option>
                                            <option
                                                value="36" {{ 36 == old("periodic_radiation_inspection") ? 'selected':'' }}>{{__("36 tháng")}}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="last_radiation_inspection" type="date" class="form-control"
                                                   value="{{ old("last_radiation_inspection") }}"
                                                   data-error="Vui lòng nhập Ngày kiểm xạ gần nhất">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" min="0" max="100" name="present_value"
                                                       placeholder="0% ..." class="form-control"
                                                       value="{{ Request::old('present_value') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="maintenance_id">
                                                ...
                                                @foreach ($maintenances as $maintenance)
                                                    <option
                                                        value="{{ $maintenance->id }}" {{ ($maintenance->id)  == (Request::old('maintenance_id')) ? "selected" : ""}}>
                                                        {{ $maintenance->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="repair_id">
                                                ...
                                                @foreach ($repairs as $repair)
                                                    <option
                                                        value="{{ $repair->id }}" {{ ($repair->id)  == (Request::old('repair_id')) ? "selected" : ""}}>
                                                        {{ $repair->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="process" placeholder="Quy trình sử dụng ..."
                                                   value="{{ Request::old('process') }}" class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="first_information" type="date" class="form-control"
                                                   value="{{ $cur_day }}"
