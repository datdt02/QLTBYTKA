    ...
    <div id="list-events" class="content-wrapper events">
        ...
        <section class="content">
            <div class="head container">
                <h1 class="title">{{ __('Danh sách thiết bị') }} (<span
                        class="text-danger">{{ $equipments->total() }}</span>)</h1>
                <a href="{{ route('equipment.index') }}" class="btnprn btn float-right"> <i class="fas fa-print"></i>
                    Xuất bản </a>
            </div>
            <div class="main">
                <div class="row search-filter">
                    <div class="col-md-2 filter">
                        <ul class="nav-filter">
                            <li class="active"><a href="{{ route('equipment.index') }}">{{ __('Tất cả') }}</a>
                            </li>
                            <li class=""><a class="btn btn-success" style="color: #fff;"
                                    href="{{ route('equipment.export', ['key' => $keyword, 'departments_id' => $departments_key, 'cate_id' => $cates_key, 'device_id' => $devices_key, 'status_id' => $status]) }}"><i
                ...
                <div class="pt-3">
                    <div class="card">
                        <div class="card-body p-0">
                                            ...
                                            @if (!$equipments->isEmpty())
                                                @foreach ($equipments as $key => $equipment)
                                                    <tr>
                                                        <td>{{ $key + 1 }}</td>
                                                        <td class="image"><a
                                                                href="{{ route('equipment.edit', $equipment->id) }}">{!! image($equipment->image, 100, 100) !!}</a>
                                                        </td>
                                                            ...
                                                            @if ($equipment->status == 'not_handed')
                                                                @can('equipment.hand')
                                                                    <a class="text-dark hand" title="Bàn giao"
                                                                        ...
                                                                        data-href="{{ route('equipment.updateHandOver', $equipment->id) }}">
                                                            ...
                                                            @elseif ($equipment->status == 'inactive')
                                                                @can('equipment.liquidation')
                                                                    <a class="inactive" title="Thanh lý thiết bị"
                                                                        data-href="{{ route('equipment.updateInactive', $equipment->id) }}">
                                          ...
                                          @endcan --}}
                                                            @elseif($equipment->status != 'corrected' && $equipment->status != 'was_broken' && $equipment->status != 'liquidated')
                                                                <a class="text-danger was_broken_mediacal" title="Báo hỏng"
                                                                    data-title="{{ $equipment->title }}"
                                                                    data-href="{{ route('equipment.updateWasBroken', $equipment->id) }}">
                                                                    <i class="fas fa-exclamation-circle"></i>
                                                                </a>
                                                            @endif
                                                            @can('equipment.create_supplie')
                                                                <a title="Nhập vật tư kèm theo"
                                                                    href="{{ route('equipment.createSupplie', $equipment->id) }}">
                                                            ...
                                                            @can('equipment.update')
                                                                <a class="text-danger" title="Xóa thiết bị"
                                                                    href="{{ route('equipment.delete', $equipment->id) }}"
                            ...
                            <form action="{{ route('equipment.index') }}" class="equipments" method="GET">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="hand_form" action="" name="frmProducts"
                        data-filter="{{ route('equiment.selectHandOver') }}" class="form-horizontal" method="POST"
                        novalidate="">
                        @csrf
                        @method('PUT')
