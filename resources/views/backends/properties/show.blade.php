        ...
        <section class="content">
            <div class="container">
                <div class="head">
                    ...
                    <a href="{{ route('eqproperty.show', $equipments->id) }}" class="btnprn btn btn-outline-dark"> <i
                            class="fas fa-print"></i> Xuất bản </a>
                    <a href="{{ route('eqproperty.showPdf', $equipments->id) }}" class="btn btn-outline-dark"> <i
                                    ...
                                    <table class="table ">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    {{ isset($equipments->eqproperty_department->title) ? $equipments->eqproperty_department->title : '' }}
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $equipments->created_at->format('H:i d-m-Y') }}</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        @if ($item->description == 'liquidated')
                                                            {{ isset($item->changes['attributes']['liquidation_date']) ? $item->changes['attributes']['liquidation_date']->format('H:i d-m-Y') : '' }}
                                                        @else
                            ...
                            <tbody>
                                @if ($equipments->status != 'not_handed' && $equipments->date_delivery != '')
                                    ...
                                    {{ isset($equipments->equipment_user->name) ? $equipments->equipment_user->name :''  }}
                                        ...
                                        <td>
                                            @foreach ($equipments->eqproperty_user_use as $number_use => $item)
                                                {{ $number_use > 0 ? ', ' : '' }} {{ $item->name }}
                                            @endforeach
                                        </td>
                                        <td>
                                            {{ date('d-m-Y', strtotime($equipments->date_delivery)) }}
                                        </td>
                                    </tr>
                                @else
                                    <tr>
