...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function simplePaginate($perPage, $total = null, $page = null, $pageName = 'page')
        {
                        return \Illuminate\Support\Collection::simplePaginate($perPage, $total, $page, $pageName);
        }
